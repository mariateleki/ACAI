...
SPREADSHEET_ID = "1CVxcSGuLTE5_Yf_BS_owyEP4OOPnoD4ch7Gm0cPzum0"
SHEET_NAME = "Sheet1"
BATCH_SIZE = 5000 
...
def load_forms(path="./data/google_forms.txt"):
    ...
    with open(path, newline="", encoding="utf-8") as f:
        ...
        for row in reader:
            UID, form_id, *_ = [x.strip() for x in row]
...
if __name__ == "__main__":
    ...
    # SINGLE (BATCHED) WRITE PHASE
    append_rows_batched(sheets_service, all_rows)

    print("\nDONE — all responses merged safely.")
